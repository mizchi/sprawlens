...
const profile = {
  ...
  nodes: [
    ...
    { id: 2, callFrame: { functionName: "main", url: "file:///repo/src/a.ts", lineNumber: 4, columnNumber: 0 }, children: [3, 5] },
    { id: 3, callFrame: { functionName: "wrap", url: "file:///repo/node_modules/x/i.js", lineNumber: 0, columnNumber: 0 }, children: [4] },
    { id: 4, callFrame: { functionName: "beta", url: "file:///repo/src/a.ts", lineNumber: 1, columnNumber: 0 } },
    { id: 5, callFrame: { functionName: "delta", url: "file:///repo/src/a.ts", lineNumber: 9, columnNumber: 0 } },
  ],
  samples: [4, 4, 5, 2],
    ...
    result: [
      {
        ...
        functions: [
          { functionName: "foo", ranges: [{ startOffset: 0, endOffset: 50, count: 3 }], isBlockCoverage: false },
          { functionName: "bar", ranges: [{ startOffset: 51, endOffset: 80, count: 0 }], isBlockCoverage: false },
          { functionName: "", ranges: [{ startOffset: 81, endOffset: 90, count: 9 }], isBlockCoverage: false },
        ],
      },
      {
        scriptId: "2",
        url: "file:///repo/node_modules/x/i.js",
        functions: [{ functionName: "lib", ranges: [{ startOffset: 0, endOffset: 5, count: 7 }], isBlockCoverage: false }],
      },
    ],
  };
